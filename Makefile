...
test: ## Run all tests
	...
	cd services/balance-api && go test ./...
...
test-v: ## Run all tests with verbose output
	...
	cd services/balance-api && go test -v ./...
...
build: ## Build all services
	...
	cd services/balance-api && go build -o ../../bin/balance-api .
...
tidy: ## Run go mod tidy for all modules
	...
	cd services/balance-api && go mod tidy
...
fmt: ## Format all Go files
	...
	cd services/balance-api && go fmt ./...
